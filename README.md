...
**Problem statement**:- The aim of the project is to predict fraudulent credit card transactions using machine learning models.
...
**Train/Test Split**: Now we are familiar with the train/test split, which we can perform in order to check the performance of our models with unseen data. Use SMOTE technique to balance the target variable.
